...
//电阻屏芯片连接引脚
#define PEN  *(u32 *)(XPAR_HIER_PERIPH_TFT_GPIO_PEN_BASEADDR)   	//PC1  INT
//#define DOUT    	//PC2  MISO
#define TDIN *(u32 *)(XPAR_HIER_PERIPH_TFT_GPIO_MOSI_BASEADDR)  	//PC3  MOSI
#define TCLK *(u32 *)(XPAR_HIER_PERIPH_TFT_GPIO_SCL_BASEADDR) 	//PC0  SCLK
#define TCS  *(u32 *)(XPAR_HIER_PERIPH_TFT_GPIO_TCS_BASEADDR)  	//PC13 CS
...
u8 TP_judgment(int x,int y);					//判断按键的范围
void TP_Top(u8* level,u8* clkdiv,float* yscale);
